...
class OS_Shortcode {
    ...
    public function shortcode($attributes) {
        ...
        $scripts_to_include = array('os_widgets' => 'http://cdn.onescreen.net/os/static/apps/s/_onescreen.js');
        ...
        $attributes = shortcode_atts(
            array(
                'item' => '',
                'widget_id' => $this->options['os_default_widget_id_setting'],  
                'target_div' => 'os_dmp_embed_' . $this->target_div_counter(),
                'custom_render_css' => '',
        ...
        $target_div = '<div id="'.$target_div.'" class="load-os-app" '.attributes_to_data($attributes, $passthrough_url).' version="1.3.7"></div>';
